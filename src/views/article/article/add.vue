      ...
      >
        <n-form ref="formRef" :model="model" :rules="rules">
          ...
          <n-form-item path="sticky" :show-label="false">
            <n-checkbox v-model:checked="model.sticky"> 置顶</n-checkbox>
          </n-form-item>
          <n-space justify="end">
            <n-button @click="showModal = false">取消</n-button>
            <n-button @click="save" type="success" dashed> 保存</n-button>
          </n-space>
        </n-form>
      </n-card>
    </n-modal>
...
<script lang="ts" setup>
  ...
  const isMobile = useProjectSetting().getIsMobile;
  const height = '640px';
